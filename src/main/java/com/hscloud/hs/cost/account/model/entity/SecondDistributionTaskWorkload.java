...
@TableName("second_distribution_task_workload")
@Schema(description = "二次分配任务工作量绩效表")
public class SecondDistributionTaskWorkload extends Model<SecondDistributionTaskWorkload> {

    private static final long serialVersionUID = 1L;

    @Schema(description = "工作量绩效id")
