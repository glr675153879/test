...
@TableName("nfjx_dw.dws_finance_out_fee_30d")
@Schema(description="门诊收费30d汇总表")
public class DwsFinanceOutFee30d extends Model<DwsFinanceOutFee30d> {
    ...
    @Schema(description = "药耗费用")
    private BigDecimal amoutMed;

    @Schema(description = "非药耗费用")
    private BigDecimal amountNoneMed;
