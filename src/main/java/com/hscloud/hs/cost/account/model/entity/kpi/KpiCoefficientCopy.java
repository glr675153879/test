...
@TableName("kpi_coefficient_copy")
public class KpiCoefficientCopy extends Model<KpiCoefficientCopy>{
    ...
    @Column(comment="字典类型", type = MySqlTypeConstant.VARCHAR, length = 100 )
    private String dicType;

    @TableField(value = "dic_code")
    @Column(comment="字典值", type = MySqlTypeConstant.VARCHAR, length = 100 )
