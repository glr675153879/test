...
@TableName("kpi_item")
public class KpiItem extends Model<KpiItem> {
    ...
    @Column(comment = "转科逻辑版本 0-旧版 1-新版", type = MySqlTypeConstant.CHAR, length = 1, isNull = false, defaultValue = "0")
    private String changeVersion;

    @TableField(value = "equivalent_flag")
    @Column(comment = "是否按当量计算 0-否 1-是", type = MySqlTypeConstant.CHAR, length = 1, isNull = false, defaultValue = "0")
    private String equivalentFlag;

    @TableField(value = "assign_flag")
    @Column(comment = "是否当量分配 0-否 1-是", type = MySqlTypeConstant.CHAR, length = 1, isNull = false, defaultValue = "0")
    private String assignFlag;

    @TableField(value = "pro_category_code", updateStrategy = FieldStrategy.ALWAYS)
    @Column(comment = "项目分类", type = MySqlTypeConstant.VARCHAR, length = 50)
    private String proCategoryCode;

    @TableField(value = "service_item_category_code", updateStrategy = FieldStrategy.ALWAYS)
