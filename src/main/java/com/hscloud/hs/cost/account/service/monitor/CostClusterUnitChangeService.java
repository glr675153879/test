 ...
 **/
@Component
public class CostClusterUnitChangeService implements DataChangeMonitor {
    private final static String ADD = "新增归集单元\"%s\"";
    private final static String UPDATE = "科室归集名称由\"%s\"变更为\"%s\"";

    private final static String ENABLE = "启用归集单元\"%s\"";
    private final static String DISABLE = "停用归集单元\"%s\"";

    private final static String DELETE = "删除归集单元\"%s\"";

    @Override
    public String getTableName() {
        return ImputationTableEnum.COST_CLUSTER_UNIT.getCode();
    }
