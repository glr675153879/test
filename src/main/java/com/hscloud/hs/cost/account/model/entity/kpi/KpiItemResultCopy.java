...
@TableName("kpi_item_result_copy")
public class KpiItemResultCopy extends Model<KpiItemResultCopy> {
    ...
    @Column(comment = "开医嘱医生/护士", type = MySqlTypeConstant.BIGINT)
    private Long kzys;
    ...
    @Column(comment = "复制时间", type = MySqlTypeConstant.DATETIME)
