...
@TableName("nfjx_dw.dws_finance_inpat_nurse_fee_30d")
@Schema(description ="住院护理收入30d汇总表")
public class DwsFinanceInpatNurseFee30d extends Model<DwsFinanceInpatNurseFee30d> {
    ...
    @Schema(description = "核算科室单元id")
    private Long accountUnitNurId;

    @Schema(description = "核算科室单元名称")
