 ...
 * 科主任绩效出参
 * @author banana
 * @create 2023-12-06 10:52
 */
@Data
public class DepartmentHeadPerformanceListVo {
    ...
    private BigDecimal supportPerf=BigDecimal.ZERO;

    @Schema(description = "绩效工资明细_业绩绩效")
    private BigDecimal perforPerf=BigDecimal.ZERO;

    @Schema(description = "绩效工资明细_工作量绩效")
    private BigDecimal workloadPerf=BigDecimal.ZERO;
}
