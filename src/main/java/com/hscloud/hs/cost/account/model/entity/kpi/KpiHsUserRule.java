...
@TenantTable
@Schema(description = "考勤计算规则(kpi_hs_user_rule)")
@TableName("kpi_hs_user_rule")
public class KpiHsUserRule extends Model<KpiHsUserRule> {
    ...
    @Column(comment = "分组code", type = MySqlTypeConstant.CHAR)
