...
import com.hscloud.hs.cost.account.model.entity.AdsMonitorAccountItem;
 ...
 */
@Mapper
public interface AdsMonitorAccountItemMapper extends BaseMapper<AdsMonitorAccountItem> {
